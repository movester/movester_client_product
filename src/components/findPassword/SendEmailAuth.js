...
function SendEmailAuth({ email, onChange, onSubmit, errModalOn, handleErrModal, errMsg }) {
  return (
    <>
      <FindPasswordWrapper>
        <p className="wrapper__todo">가입하신 이메일을 작성해주세요.</p>
        <FormWrapper onSubmit={onSubmit}>
          <StyledInput type="email" name="email" placeholder="이메일" value={email} onChange={onChange}/>

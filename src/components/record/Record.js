...
import { GrayBg, StyledGrayBg } from '../elements/GrayBg';
import Button from '../elements/Button';
import MoveLink from '../common/MoveLink';
import Graph from './Graph';

function Record({ sholuderRecords, legRecords }) {
  return (
    <StyledWrap>
      <StyledGrayWrap>
      ...
      <div className="graph-wrap">
        <div className="graph-one">
          ...
          <Graph records={sholuderRecords} type="shoulder" />
          <Link to="/mypage/record/shoulder">
            <p>오늘의 어깨 기록하러가기 {'>'}</p>
          </Link>
        </div>
...
Record.propTypes = {
  sholuderRecords: PropTypes.arrayOf(PropTypes.object).isRequired,
